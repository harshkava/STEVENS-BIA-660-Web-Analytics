...
movies = pd.read_csv('D:\\Courses\\04_Web Analytics\\Study Material\\Final Project\\sample2.txt',sep='\t',header=0)
movies.shape
list(movies)
...
def processActors(movies):
    try:
        ...
        print('Exception in processActors')
        print('Exception is ::',e)   
        return movies

def processDirectors(movies):
    try:
        ...
        print('Exception in processDirectors')
        print('Exception is ::',e)   
        return movies

def processStudio(movies):
    try:
...
#==============================================================================
movies= processGenre(movies)
print("Completed : processGenre")
movies= processActors(movies)
print("Completed : processActors")
movies= processDirectors(movies)
print("Completed : processDirectors")
movies= processStudio(movies)
print("Completed : processStudio")
movies= processWriter(movies)
...
# 
# =============================================================================
# X_train, X_test, y_train, y_test = train_test_split(movies, y, test_size=0.2)
...
# X = movies.values# create an array
# y = y.values # Create another array
...
# scores = cross_val_score(lm, movies, y, cv=6)
