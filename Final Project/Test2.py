# -*- coding: utf-8 -*-
"""
Created on Sun Apr 29 18:27:00 2018
...
movies.drop(['actor_names','actor_links','synopsis','In Theaters','Genre','Studio','Directed By','Box Office','Rating','Written By'],axis=1,inplace=True)
movies.to_csv("Result.csv")